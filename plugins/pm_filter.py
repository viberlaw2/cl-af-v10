...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton("ɢʀᴏᴜᴩ", url="https://t.me/+-bNZdLnZLtI0NTFl")
            ],[
            InlineKeyboardButton("ᴜᴩᴅᴀᴛᴇꜱ", url="https://t.me/+oJ1GoYnsjwUwYTI1")
            ],[      
        ...
        buttons= [[
            InlineKeyboardButton('ꜱᴏᴜᴄʀᴇ ❗️ ᴄᴏᴅᴇ', callback_data='source')
            ],[
            InlineKeyboardButton('🏠 ʜᴏᴍᴇ ', callback_data='start'),
            InlineKeyboardButton('ᴄʟᴏꜱᴇ 🔐', callback_data='close_data')
        ]]
        ...
        buttons = [[
            InlineKeyboardButton('SOURCE CODE', url='https://t.me/+oJ1GoYnsjwUwYTI1')
            ],[
